...
const tableRowSelect = (event, table_type, row_class) => {
  if (
    ...
    if (!event.ctrlKey && !event.shiftKey) {
      ...
      let pivotIndex = document.getElementsByClassName("pivot-selection")[0]
        .rowIndex;
...
const getSelectedRows = (event, list, alt_list) => {
  let selected = document.getElementsByClassName("table-selected");
  if (alt_list != null) {
        ...
        >
          ...
          <div className="collapse navbar-collapse" id="navbarSupportedContent">
            <ul className="navbar-nav mr-auto">
              <li id="navbar-home" className="nav-item active main-navbar-item">
                <a onClick={this.props.welcomeScreen} className="nav-link">
                  Home
                </a>
              </li>
              <li id="navbar-songs" className="nav-item main-navbar-item">
                <a onClick={this.props.songList} className="nav-link">
                  Songs
                </a>
              </li>
              <li id="navbar-artists" className="nav-item main-navbar-item">
                <a onClick={this.props.artistList} className="nav-link">
                  Artists
                </a>
              </li>
              <li id="navbar-albums" className="nav-item main-navbar-item">
                <a onClick={this.props.albumList} className="nav-link">
                  Albums
                </a>
              </li>
              <li
              ...
              >
                <a onClick={this.props.openSearchModal} className="nav-link">
                  Advanced Search
                </a>
              </li>
            </ul>
              ...
              <li className="nav-item">
                <div style={{ position: "relative" }}>
                  ...
                  <i
                    ...
                    className="navbar-rating material-icons song-icon-button"
                    style={{ color: "gray", top: 8, left: 25 }}
                  >
                    {stars[1]}
                  </i>
                  <i
                    ...
                    className="navbar-rating material-icons song-icon-button"
                    style={{ color: "gray", top: 8, left: 45 }}
                  >
                    {stars[2]}
                  </i>
                  <i
                    ...
                    className="navbar-rating material-icons song-icon-button"
                    style={{ color: "gray", top: 8, left: 65 }}
                  >
                    {stars[3]}
                  </i>
                  <i
                    ...
                    className="navbar-rating material-icons song-icon-button"
                    style={{ color: "gray", top: 8, left: 85 }}
                  >
                    {stars[4]}
                  </i>
                </div>
...
class Song extends React.Component {
  ...
  render() {
    ...
    const firstColumn = this.state.hovering ? (
      <i onClick={this.onPlayClick} className="material-icons song-icon-button">
        play_arrow
      </i>
    ...
    return (
      ...
      >
        ...
        <td style={{ overflow: "hidden" }}>{formatTime(song_info.length)}</td>
        <td style={{ overflow: "hidden" }}>
          <span className="detail-page-link" onClick={this.onArtistLink}>
            {song_info.artist}
          </span>
        </td>
        <td style={{ overflow: "hidden" }}>
          <span
            className={this.props.album_view ? "" : "detail-page-link"}
  ...
  render() {
    ...
    return (
      ...
      >
        ...
        >
          <span className="detail-page-link" onClick={this.artistClick}>
            {song.album_artist}
          </span>
          <span style={{ color: "gray" }}>
            {song.album_artist_alt ? " / " + song.album_artist_alt : ""}
          </span>
        </div>
        <div
          style={{
...
class SongList extends React.Component {
  ...
  addNext = event => {
    this.props.addToPlaylist(getSelectedRows(event, this.props.data.data), 1);
  };
  addQueue = event => {
    this.props.addToPlaylist(getSelectedRows(event, this.props.data.data), 0);
  };
  editInfo = event => {
    this.props.editInfo("song", getSelectedRows(event, this.props.data.data));
  };
  addAllToPlaylist = method => event => {
    if (this.props.total_size > pageLength && this.props.data.data.length > 0) {
    ...
    return (
      <div>
        ...
        <table
          id="song-table"
          className="table"
          style={{ whiteSpace: "nowrap", tableLayout: "fixed", minWidth: 100 }}
        >
          <thead>
            <tr>
              ...
              <th style={{ width: 40 }} scope="col">
                <div style={{ position: "relative", top: -25, left: -11 }}>
                  <a
                    role="button"
                    id="dropdownMenuSong"
              ...
              <th
                ...
                scope="col"
              >
                <i className="material-icons" style={{ fontSize: 24, top: 5 }}>
                  schedule
                </i>
              </th>
              <th
  ...
  render() {
    ...
    let labels = (
      <div style={{ position: "absolute", top: 201, left: 5 }}>
        ...
        >
          <span className="detail-page-link" onClick={this.artistLabelClick}>
            {info.album_artist}
          </span>
        </div>
        {dropdown_button}
    ...
    return (
      ...
      >
        <div
          ...
          aria-labelledby="dropdownMenuSong"
        >
          <a onClick={this.addToPlaylist(1)} className="dropdown-item">
            Play Next
          </a>
          <a onClick={this.addToPlaylist(0)} className="dropdown-item">
            Add to Queue
          </a>
          <a onClick={this.editInfo} className="dropdown-item">
            Edit Info
  ...
  render() {
    ...
    return (
      ...
      >
        ...
        >
          <span
            className={this.props.albums === true ? "detail-page-link" : ""}
...
class PlaylistSong extends React.Component {
  ...
  onMouseOver = event => {
    if (
      !document.getElementById("playlist-table").classList.contains("dragging")
    ) {
      this.setState({ hovering: true });
    }
  };
  ...
  render() {
    ...
    return (
      ...
      >
        ...
        <td style={{ overflow: "hidden", position: "relative" }}>
          <div style={{ position: "absolute", top: 6, fontSize: "0.75rem" }}>
            {song_info.title}
          </div>
          <div
            style={{
          ...
          >
            ...
            <span> - </span>
            <span className="detail-page-link" onClick={this.albumClick}>
              {song_info.album}
            </span>
          </div>
          <div
...
class SearchFormRow extends React.Component {
  ...
  render() {
    if (this.props.data["col"] === "image") {
      return (
        <div className="form-group form-row" style={{ marginBottom: "1.0rem" }}>
    ...
    if (column_objects[this.props.data["col"]]["type"] === 0) {
      return (
        <div className="form-group form-row" style={{ marginBottom: "0.0rem" }}>
          ...
          <div className="col-11 mui-textfield mui-textfield--float-label">
            ...
            />
            <label
              htmlFor={"input-search-" + column_objects[this.props.data["col"]]}
            >
      ...
      if (this.props.type !== "edit") {
        ...
        op_selection = (
          <div
            ...
            style={{ opacity: 1, paddingRight: 10, height: "50%", top: 16 }}
            data-toggle="buttons"
          >
            <label
            ...
            >
              <input type="radio" name="options" autoComplete="off" />B
            </label>
          </div>
        );
          ...
          additional_field = (
            <div className="col-4 mui-textfield">
              <input
                ...
                type={col_type}
                className="form-control"
                id={"input-search-2-" + column_objects[this.props.data["col"]]}
                onChange={this.valueChange2}
                value={this.props.data["value2"]}
                autoComplete="off"
                required
              />
              <label htmlFor={"input-search-2-" + this.props.data["col"]}>
                {column_objects[this.props.data["col"]]["name"]}
              </label>
            </div>
          );
        ...
        <div className="form-group form-row">
          ...
          <div className={col_size + " mui-textfield"}>
            <input
              ...
              type={col_type}
              className="form-control"
              id={"input-search-" + column_objects[this.props.data["col"]]}
              onChange={this.valueChange1}
              value={this.props.data["value1"]}
              autoComplete="off"
              required
            />
            <label htmlFor={"input-search-" + this.props.data["col"]}>
              {column_objects[this.props.data["col"]]["name"]}
            </label>
          </div>
          {additional_field}
...
class EditModal extends React.Component {
  constructor(props) {
    ...
    this.state = {
      ...
      image_id: value,
      size:
        this.props.edit_data.length <= 50 ? this.props.edit_data.length : ">50"
    };
  }
  handleSubmit = event => {
    event.preventDefault();
    ...
    return (
      <div>
        ...
        >
          ...
          >
            Editing{" "}
            {this.state.size + (this.state.size === 1 ? " Song" : " Songs")}
          </div>
          {artwork}
        </div>
        <form
        ...
        >
          ...
          <div className="form-group form-row">
            <div className="col-2">
              <button type="submit" id="edit-save" className="btn btn-success">
                Save
              </button>
            </div>
            <div className="dropdown col-4" style={{ paddingLeft: 15 }}>
              <button
...
class SearchModal extends React.Component {
  ...
  onCheck = type => event => {
    if (type === 0) {
      ...
      this.setState({ album_artist_grouped: !this.state.album_artist_grouped });
    } else if (type === 2) {
  ...
  handleSubmit = event => {
    ...
    for (let i = 0; i < data.length; i++) {
      ...
      if (op === "BT") {
        request["base_params"][col] = op + ":::" + value1 + ":::" + value2;
      } else {
  ...
  render() {
    ...
    for (let i = 0; i < searchable_columns.length; i++) {
      if (
        column_objects[searchable_columns[i]]["availability"] <= availability
      ) {
        let found = false;
        for (let j = 0; j < data.length; j++) {
          ...
          <div className="form-group row">
            <div className="col-12">
              ...
              <div className="form-check">
                ...
                />
                <label className="form-check-label" htmlFor="composer_grouped">
                  Composer Grouped
                </label>
              </div>
              <div className="form-check">
                ...
                />
                <label className="form-check-label" htmlFor="publisher_grouped">
                  Publisher Grouped
                </label>
              </div>
            </div>
...
class AudioApp extends React.Component {
    ...
    if (total_size <= pageLength) {
      ...
      if (total_size <= maxPlaylistSize) {
        ...
        if (this.state.shuffle === true) {
          ...
          requestNew["base_params"]["exclude"] = data[index_position].id;
        }
        axios
        ...
        if (
          ...
          requestEnd["base_params"]["max_results"] = total_size - position;
          let requestFront = {};
          ...
          if (this.state.shuffle === true) {
            ...
            requestNew["base_params"]["max_results"] = maxPlaylistSize - 1;
          }
          axios
            .get(requestNew["base_url"], {
              params: requestNew["base_params"]
            ...
            .then(response => {
              if (this.state.shuffle === true) {
                response.data.data.unshift(
                  JSON.parse(JSON.stringify(data[index_position]))
                );
              }
  ...
  addNext = event => {
    this.addToPlaylist(getSelectedRows(event, this.state.current_playlist), 1);
  };
  addQueue = event => {
    this.addToPlaylist(getSelectedRows(event, this.state.current_playlist), 0);
  };
  getPlaylistEditData = event => {
    this.editInfo("song", getSelectedRows(event, this.state.current_playlist));
  };
    ...
    for (let i = data.length - 1; i >= 0; i--) {
      ...
      if (next === 0 && this.state.shuffle === true) {
        let swap_index = Math.floor(
          Math.random() * (new_playlist.length - (current_index + 2)) +
            (current_index + 1)
        );
  ...
  updatePlaying = () => {
    ...
    if (this.state.current_playlist.length > 0) {
      let now_playing = document.getElementById(
        "song-item-" + this.state.current_playlist[this.state.current_index].id
      );
      if (now_playing != null) {
      ...
      now_playing = document.getElementById(
        "playlist-song-item-" +
          this.state.current_playlist[this.state.current_index].playlist_id
      );
      if (now_playing != null) {
        now_playing.classList.add("now_playing");
      }
  ...
  updatePlaycount = () => {
    ...
    if (audio.currentTime > 10) {
      ...
      let elements = document.getElementsByClassName(
        "song-id-" + this.state.current_playlist[this.state.current_index].id
      );
  ...
  timeUpdate = event => {
    ...
    let playPercent =
      100 *
      (audio.currentTime /
        (this.state.current_playlist[this.state.current_index].length * 100));
  ...
  seek = event => {
    ...
    audio.currentTime =
      this.state.current_playlist[this.state.current_index].length * percent;
  };
  ...
  updateRatings = (new_rating, ids) => {
    ...
    for (let i = 0; i < ids.length; i++) {
      let listElements = document.getElementsByClassName("song-id-" + ids[i]);
      ...
      if (playlistElements.length > 0) {
        for (let i = 0; i < playlistElements.length; i++) {
          playlist[playlistElements[i].rowIndex - 1].rating = new_rating;
        }
      }
    }
  ...
  albumClickPassthrough = event => {
    if (this.state.current_playlist.length > 0) {
      this.albumClick(
        ...
        this.state.current_playlist[this.state.current_index].album_artist
      );
    }
  };
  artistClick = artist => {
  ...
  updateNavigation = location => {
    if (location.pathname === "/" || location.state == null) {
      ...
      request["base_params"]["first_result"] = pageLength * state.child_page;
      ...
      if (
        ...
        axios
          .all([
            ...
            axios.get("/api/artist/" + encodeURIComponent(state.child_key))
          ])
          .then(
  ...
  openSearchModal = event => {
    ...
    document.getElementById("advanced-search-modal-content").style.visibility =
      "visible";
    document
  ...
  closeModals = event => {
    if (
      ...
      // edit modal close
      document.getElementById("edit-modal-content").style.visibility = "hidden";
      document
  ...
  openEditModal = event => {
    ...
    document.getElementById("modal-cover").classList.add("modal-active");
    document.getElementById("edit-modal-content").style.visibility = "visible";
    document.getElementById("edit-modal-content").classList.add("modal-active");
  };
  ...
  openImage = image_id => event => {
    if (image_id != null) {
      window.open(
        axios.defaults.baseURL + "/api/song/" + image_id + "/picture?size=1000"
      );
    }
  };
  render() {
    ...
    if (
      ...
      subcomponent = (
        <SongList
          ...
          album_view={subcomponent_type === "song-list-album" ? true : false}
    ...
    const RoutingDummyWithProps = props => {
      return (
        <RoutingDummy updateNavigation={this.updateNavigation} {...props} />
      );
    };
    return (
      <div>
        ...
        >
          ...
          <a onClick={this.getPlaylistEditData} className="dropdown-item">
            Edit Info
          </a>
        </div>
        <div
        ...
        <div id="modal-cover" className="mymodal" onClick={this.closeModals} />
        <div
          id="advanced-search-modal-content"
          className="mymodal-content"
          style={{ overflow: "auto" }}
        >
          <SearchModal handleAdvancedSearch={this.handleAdvancedSearch} />
        </div>
        <div
        ...
        >
          ...
          <div style={{ position: "relative", width: "100%" }}>
            ...
            >
              ...
              <a className="player-previous" onClick={() => this.getPrevious()}>
                <i
                  className="material-icons"
              ...
              <a
                className={
                  "player-play-pause " +
                  (this.state.playStatus === "play" ? "playing" : "paused")
                }
              ...
              >
                ...
                >
                  {this.state.playStatus === "play" ? "pause" : "play_arrow"}
                </i>
              </a>
              <a className="player-next" onClick={() => this.getNext()}>
                <i
                  className="material-icons"
                  style={{ fontSize: 36, cursor: "pointer" }}
                >
            ...
            <div
              ...
              style={{ position: "absolute", left: 100, top: 5, fontSize: 12 }}
            >
              {song_info == null ? (
                ""
              ) : (
...
function getNextIndex(playlist, current_index) {
